...
const ERROR_MESSAGES: Record<string, string> = {
  domain_restricted: "Access restricted to GRG Playscapes staff only.",
      ...
      <Card className="w-full max-w-sm">
        <CardContent className="pt-8 pb-8 flex flex-col items-center gap-6">
          ...
          <div className="text-center space-y-1">
            <h1 className="text-xl font-semibold" data-testid="text-login-title">Inventory Management</h1>
            <p className="text-sm text-muted-foreground">Sign in with your GRG Playscapes account</p>
          </div>
