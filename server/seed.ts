...
export async function seedDatabase() {
  ...
  const cedarItems: { sku: string; desc: string; t: string; w: string; l: string; fp: number; mp: number; status: string; notes?: string; farmStock: number; mkeStock: number }[] = [
    ...
    { sku: "CDR BS 16", desc: "CDR 1x8x5/8\"x16' Bevel Siding", t: '1"', w: '8"x5/8"', l: "16'", fp: 0, mp: 0, status: "Active", notes: "Count per piece not per pack (packs of 6)", farmStock: 168, mkeStock: 0 },
    { sku: "CDR BS 12", desc: "CDR Beveled Siding 12'", t: '1"', w: '8"x5/8"', l: "12'", fp: 10, mp: 4, status: "Active", farmStock: 0, mkeStock: 0 },
